...
On this lesson we created a module to provision an ECS Service and studied 3 approaches of autoscale: 
...
| <a name="input_sclae_in_comparison_operator"></a> [sclae\_in\_comparison\_operator](#input\_sclae\_in\_comparison\_operator) | Scale in strategy | `string` | `"LessThanOrEqualToThreshold"` | no |
| <a name="input_sclae_out_comparison_operator"></a> [sclae\_out\_comparison\_operator](#input\_sclae\_out\_comparison\_operator) | Scale out strategy | `string` | `"GreaterThanOrEqualThreshold"` | no |
